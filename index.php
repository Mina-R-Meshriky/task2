...
$router->addRoute('get', '/products/{product}', 'Domain\Product\Http\ProductController@show');
$router->addRoute('post', '/products', 'Domain\Product\Http\ProductController@store');
$router->addRoute('delete', '/products/{product}', 'Domain\Product\Http\ProductController@delete');
